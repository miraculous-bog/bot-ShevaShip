...
const texts = {
  ...
  textForEmptyTickets: `На жаль, всі квитки продано. Підписуйся на наш канал аби першим бути в курсі про нові івенти\nhttps://t.me/joinchat/XZ3yTANnBOcxYmVi`,
  where: `_Де?_\n***Причал. Вихід з Контрактової або Поштової Площі.***\n_Коли?_ \n***24.09 з 18:00 по 23:00.***`,
  firstRegist: `Вітаємо!\nДля того, щоб  зареєструватися, ***введіть свої ім'я та прізвище.***\nПамятайте, що важливо ввести коректні дані, аби ви змогли потрапити на івент. У вас буде _лише одна спроба_\n\n***Приклад: Іван Іванов.***`,
  secondRegist: `Введіть, будь ласка, номер вашого телефону\n\nПриклад: 0930000000`,
  ...
  *Ще не придбав квиток? Купуй білети за допомогою цього бота*
  *Кількість квитків обмежена, тож не зволікай!*
  
  ⚪️**Перші 40 квитків – 250 UAH**
  ⚫️**Решта 50 квитків – 300 UAH**
  ...
  *Ну що, курс на відрив!*🥂\nОбов'язково підпишися на наш канал аби не пропустити наступні події\nhttps://t.me/joinchat/XZ3yTANnBOcxYmVi`,
  ...
  if (user.state[0] === 1 && user.state[0] === 1) {
    ...
    if (checkNumber(msg.text)) {
      ...
      bot.sendMessage(
        ...
        `Не коректне значення!!! Спробуйте ще раз!Памятайте, повідомлення повинно бути у наступному форматі:\n\n0930000000`
      );
    }
